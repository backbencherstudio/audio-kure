...
const GoogleReviews = () => {
    ...
    return (
        <div className='py-20 px-4'>
            <h1 className='text-center merriweather text-5xl font-semibold mb-10'>Why <span className='text-[#8A5EFF]'>Kustomers</span> love <span className='text-[#8A5EFF]'>healer</span> app</h1>

...
const AudioNames = () => {
    ...
    return (
        <div className="p-4 xl:p-6">
            <h1 className='text-[22px] md:text-4xl font-bold text-white text-center mb-6'>(+200 Audios, +4000 Hours)</h1>
            <h1 className='text-base font-bold text-white text-center mb-6'>Your Ultimate Self-Hypnosis Library</h1>
            {/* Main Content */}
